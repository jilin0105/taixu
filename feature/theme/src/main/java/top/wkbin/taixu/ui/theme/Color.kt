...
// 澄明 · 深色
val ChengmingDarkPrimary = Color(0xFF4C75F2)
...
val ChengmingDarkSecondary = Color(0xFF3A82B8)
...
val ChengmingDarkTertiary = Color(0xFF8A7BE0)
val ChengmingDarkOnTertiary = Color(0xFFFFFFFF)
val ChengmingDarkTertiaryContainer = Color(0x66332A6B)
val ChengmingDarkOnTertiaryContainer = Color(0xFFE4DCFF)
val ChengmingDarkError = Color(0xFFE5484D)
